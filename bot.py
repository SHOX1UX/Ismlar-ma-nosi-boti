...
# from ismlar.ismlar import ismlar_manosi
...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum botga xush kelibsiz\nHohlagan ism kiriting bot bu ismni ma'nosini chiqarib beradi")
    except:
        await message.answer(text="Assalomu alaykum botga xush kelibsiz\nHohlagan ism kiriting bot bu ismni ma'nosini chiqarib beradi")
